  ...
  return (
    <div className="flex h-screen bg-[#050505] text-white overflow-hidden font-sans relative">
      ...
      <main className="flex-1 md:pl-20 pb-16 md:pb-0 overflow-y-auto custom-scrollbar">
        {/* Dashboard Header */}
        <header className="min-h-16 py-3 px-4 md:px-10 flex flex-wrap items-center justify-between gap-4 border-b border-white/5 bg-black/40 backdrop-blur-md sticky top-0 z-40">
          <div className="flex items-center gap-4 md:gap-6 overflow-x-auto no-scrollbar">
             ...
             <div className="flex flex-col shrink-0">
               ...
               <span className="text-[11px] font-mono uppercase tracking-widest text-white/60">20:53:12 UTC</span>
             </div>
          </div>

          <div className="flex items-center gap-4 md:gap-6">
             <div className="text-right hidden sm:block">
               <span className="text-[10px] uppercase tracking-[0.3em] text-white/30 block">Authorized Access</span>
               <span className="text-[11px] font-mono text-white/80">SHEPHERD_LEVEL_01</span>
             </div>
        ...
        <div className="p-4 md:p-10 grid grid-cols-12 gap-4 md:gap-6 fluid-container">
          ...
          {/* Transaction Feed - Moves to bottom or side */}
          <section className="col-span-12 xl:col-span-4 order-2 xl:row-span-2 overflow-hidden">
            <TransactionFeed />
          </section>

          {/* Stat Cards */}
          <section className="col-span-12 xl:col-span-8 order-3">
